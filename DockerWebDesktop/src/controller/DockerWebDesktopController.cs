...
namespace controller
{
	public class DockerWebDesktopController : DockerWebDesktopControllerUtils, IDefaultController
	{
		...
		public HttpListenerUtils.OutputBody ApiSettingRun(int? hash, string name, string version)
		{
			RunTimeUtils.ExecResult execResult = this.service.ApiSettingRun(hash, name, version);
		...
		public HttpListenerUtils.OutputBody ApiBuildDockerfile(int? hash, string name, string version)
		{
			RunTimeUtils.ExecResult execResult = this.service.ApiBuildDockerfile(hash, name, version);
		...
		public HttpListenerUtils.OutputBody ApiDeployDockerComposeYml(int? hash, string name, string version)
		{
			RunTimeUtils.ExecResult execResult = this.service.ApiDeployDockerComposeYml(hash, name, version);
